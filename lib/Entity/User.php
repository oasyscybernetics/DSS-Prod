...
class User implements \JsonSerializable
{
    ...
    */
    ...
    public function checkGeneric($password) {
	
	if ((strpos($password, 'ubi') !== false) || (strpos($password, 'UBI') !== false)) {
		return true;
	}
	else if ((strpos($password, 'Ubi') !== false) || (strpos($password, 'UBi') !== false) || (strpos($password, 'UbI') !== false)) {
		return true;
	}
	else if ((strpos($password, 'uBi') !== false) || (strpos($password, 'uBI') !== false) || (strpos($password, 'ubI') !== false)) {
		return true;
	}
	else if ((strpos($password, '123') !== false) || (strpos($password, '234') !== false) || (strpos($password, '345') !== false) || (strpos($password, '456') !== false) || (strpos($password, '567') !== false) || (strpos($password, '678') !== false) || (strpos($password, '789') !== false) || (strpos($password, '890') !== false) || (strpos($password, '901') !== false) || (strpos($password, '012') !== false)) {
		return true;
	}
	else {
		return false;
