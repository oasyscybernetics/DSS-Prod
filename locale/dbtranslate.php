...
echo __('Should UBI send an email if a display is in an error state every time the maintenance script runs?');
echo __('Send Schedule in advance?');
echo __('Should UBI send future schedule information to clients?');
...
echo __('This is the fully qualified URI of the site. e.g http://www.oasys.co/');
...
echo __('Should the server send anonymous statistics back to the ubi project?');
echo __('Key used to distinguish each ubi instance. This is generated randomly based on the time you first installed ubi, and is completely untraceable.');
